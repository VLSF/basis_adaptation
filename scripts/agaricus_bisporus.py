...
from architectures import basis_siren_1
...
if __name__ == "__main__":
    ...
    if D == 1:
        model = basis_siren_1.SLNO_siren_1D(*NN_args)
    elif D == 2:
        model = basis_siren_1.SLNO_siren_2D(*NN_args)
    elif D == 3:
        model = basis_siren_1.SLNO_siren_3D(*NN_args)
    else:
